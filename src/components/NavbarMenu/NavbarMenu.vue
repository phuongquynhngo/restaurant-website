<template>
  ...
  <!-- <div class="navbar-menu-wrapper">
    <div><p>Navbar Menu</p></div>
    <div class="c-tags" ref="cTags" v-for="(category, categoryName) in itemsData.categories" :key="categoryName">
...
// function slidePrev() {
//   const scrollWidth = cTags.value?.scrollWidth;
//   const clientWidth = cTags.value?.clientWidth;

//   // Calculate the previous scroll position
//   const prevScrollLeft = Math.max(cTags.value?.scrollLeft! - clientWidth!, 0);
